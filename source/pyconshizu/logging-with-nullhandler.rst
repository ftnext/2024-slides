...
* nikkie ／ :fab:`github` `@ftnext <https://github.com/ftnext>`__ ／ `ブログ <https://nikkie-ftnext.hatenablog.com/>`__ 連続640日突破
* 機械学習エンジニア（`We're hiring! <https://hrmos.co/pages/uzabase/jobs/1829077236709650481>`__）
...
* 先のコード（``NullHandler`` 以外はいけません）を **理解・納得** してもらえたら嬉しいです
